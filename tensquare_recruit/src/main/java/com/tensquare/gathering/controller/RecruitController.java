...
import com.tensquare.gathering.service.RecruitService;
...
public class RecruitController {
	...
	public Result findRecommend(){
		List<Recruit> recruitList = recruitService.findRecommend();
		return new Result(true,StatusCode.OK,"查询成功",recruitList);
	}
	@GetMapping("/search/newlist")
	public Result newList(){
		List<Recruit> recruitList = recruitService.findNewRecommend();
		return new Result(true,StatusCode.OK,"查询成功",recruitList);
	}
